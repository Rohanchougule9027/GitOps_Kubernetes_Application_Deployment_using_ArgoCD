...
### Overview
---
This project demonstrates a GitOps-driven deployment model for Kubernetes using ArgoCD. The objective is to implement a fully automated CI/CD workflow where Git acts as the single source of truth for infrastructure and application deployments.
